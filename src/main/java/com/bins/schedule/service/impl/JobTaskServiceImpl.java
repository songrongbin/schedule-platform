package com.bins.schedule.service.impl;

import com.bins.schedule.dao.ScheduleJobMapper;
import com.bins.schedule.model.ScheduleJob;
import com.bins.schedule.service.IJobTaskService;
...
public class JobTaskServiceImpl implements IJobTaskService {
    ...
    public void addJob(ScheduleJob job) throws SchedulerException {
        ...
        if (null == trigger) {
            // 重新创建
            Class clazz = ScheduleJob.CONCURRENT_IS.equals(job.getIsConcurrent()) ? SchedulerFactoryBean.class : CronTriggerFactoryBean.class;
